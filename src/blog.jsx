            ...
            <div className="w3-light-grey w3-content" style={{ maxWidth: '1600px' }}>
                ...
                <nav className="w3-sidebar w3-collapse w3-white w3-animate-left" style={{ zIndex: 3, width: '300px' }} id="mySidebar"><br />
                    ...
                    <div className="w3-bar-block">
                        <a href="./index.html" onclick="w3_close()" className="w3-bar-item w3-button w3-padding"><i className="fa fa-th-large fa-fw w3-margin-right" />HOME</a>
                        <a href="./blog.html" onclick="w3_close()" className="w3-bar-item w3-button w3-padding w3-text-teal"><i className="fa fa-user fa-fw w3-margin-right" />BLOG</a>
                    ...
                    < header id="portfolio" >
                        ...
                        <div className="w3-container">
                            ...
                            <div className="w3-section w3-bottombar w3-padding-16">
                                ...
                                <button className="w3-button w3-white"><i className="fa fa-diamond w3-margin-right" />Design</button>
                                <button className="w3-button w3-white"><i className="fa fa-photo w3-margin-right" />Photos</button>
                                <button className="w3-button w3-white"><i className="fa fa-map-pin w3-margin-right" />Art</button>
                            </div>
                        </div>
                    </header >
                    {/* First Photo Grid*/}
