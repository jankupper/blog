      ...
      <BrowserRouter>
        ...
        <img src="/w3images/avatar_g2.jpg" style="width:45%;" class="w3-round"><br><br> */}
            ...
            <div className="w3-main" style={{ marginLeft: '300px' }}>
              ...
              <Routes >
                <Route exact path="/" element={<Home state={this.state} readMore={(index) => this.readMore(index)}></Home>}></Route>
                <Route exact path="/blog" element={<Blog posts={this.state.posts} readMore={(index) => this.readMore(index)} ></ Blog>}></Route>
                <Route exact path="/blog/:id" element={<BlogEntry post={this.state.posts[this.state.index] ? this.state.posts[this.state.index] : []}></BlogEntry>}></Route>
              </Routes >
