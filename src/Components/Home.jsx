          ...
          <div className="w3-white w3-margin">
            ...
            <div className="w3-row-padding w3-white">
              <div className="w3-col s6">
                <p><img src={props.inspiration[0] ? props.inspiration[0] : ""} alt="" style={{ width: '100%' }} /></p>
                <p><img src={props.inspiration[1] ? props.inspiration[1] : ""} alt="" style={{ width: '100%' }} /></p>
              </div>
              <div className="w3-col s6">
                <p><img src={props.inspiration[2] ? props.inspiration[2] : ""} alt="" style={{ width: '100%' }} /></p>
                {/* className="w3-grayscale" */}
                <p><img src={props.inspiration[2] ? props.inspiration[3] : ""} alt="" style={{ width: '100%' }} /></p>
              </div>
            </div>
          </div>
          <hr />
